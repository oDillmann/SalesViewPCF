...
// Attribute constants
export enum EnvironmentVariableDefinitionAttributes {
  ApiId = "apiid",
...
export interface EnvironmentVariableDefinition extends IEntity {
  ...
  connectionreferenceid?: import("cdsify").EntityReference | null;
  ...
  environmentvariabledefinitionid?: import("cdsify").Guid | null;
  //  UniqueidentifierType For internal use only.
  environmentvariabledefinitionidunique?: import("cdsify").Guid | null;
  ...
  parentdefinitionid?: import("cdsify").EntityReference | null;
  //  StringType
  ...
  solutionid?: import("cdsify").Guid | null;
  ...
  supportingsolutionid?: import("cdsify").Guid | null;
